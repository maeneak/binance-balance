"""Tests for Binance Balance api."""
import asyncio

import aiohttp
from custom_components.binance_balance.api import (
    BinanceBalanceApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = BinanceBalanceApiClient("test", "test", async_get_clientsession(hass))
